...
VALUES('Victor', '1212121212', 'lorem ipsum', 20, 1500.00, 1.87, True, '2000-07-25', '07:00:00', '2021-06-01 20:00:00')
...
SELECT * FROM aluno
WHERE nome = 'Victor' OR nome = 'Marcos';

SELECT * FROM aluno
WHERE nome = 'Marcia' AND cpf IS NULL;


-- Chave primÃ¡ria (chaves primÃ¡rias identificam cada valor de uma tabela. Ela deve ser Ãºnica e nÃ£o pode ser nula)
...
/* DELETE CASCADE (caso queira deletar a tabela e ela tiver relacionada com outras, nÃ£o serÃ¡ possÃ­vel. EntÃ£o na criaÃ§Ã£o da
...
INSERT INTO funcionarios (matricula, nome, sobrenome) VALUES('M001', 'Victor', 'Henrique');
...
INSERT INTO torcedores(nome, time) VALUES('Victor', 'SÃ£o Paulo');
INSERT INTO torcedores(nome, time) VALUES('Maria', 'SÃ£o Paulo');
INSERT INTO torcedores(nome, time) VALUES('Carla', 'SÃ£o Paulo');
INSERT INTO torcedores(nome, time) VALUES('Pietra', 'Corinthians');
INSERT INTO torcedores(nome, time) VALUES('RogÃ©rio', 'Corinthians');
